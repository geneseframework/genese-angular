/*
 * Public API Surface of genese-angular-library
 */
...
export * from './lib/genese-angular-library.service';
export * from './lib/genese-angular-library.component';
export * from './lib/genese-angular-library.module';
